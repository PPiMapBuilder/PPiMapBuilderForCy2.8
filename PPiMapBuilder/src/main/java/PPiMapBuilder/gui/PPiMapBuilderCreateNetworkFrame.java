...
import PPiMapBuilder.gui.listener.PPiMapBuilderCreateNetworkFrameReferenceOrganismListener;
 ...
 */
public class PPiMapBuilderCreateNetworkFrame extends JFrame{
	 ...
	 */
	public PPiMapBuilderCreateNetworkFrame() {
	...
	private JPanel initMainFormPanel() {
		...
		comboBox.addActionListener(new PPiMapBuilderCreateNetworkFrameReferenceOrganismListener(this));
